...
const Aboutus = () => {
  ...
  <div className="bg-white relative   flex items-center justify-center overflow-hidden z-50 ">
    <div className="relative mx-auto h-full px-4  pb-8 md:pb-10  ">
      <div className="flex flex-col items-center justify-between lg:flex-row pt-12 pb-5">
        <div className=" relative ">
          ...
          <div className="max-w-6xl relative z-40">
            <h1 className="flex text-sm uppercase text-md font-semibold text-purple-600">
              About Us
            </h1>
            <h2 className="mb-6 max-w-lg text-5xl font-bold leading-snug tracking-tight  sm:text-7xl ">
            Level Up Your IT Skills
              <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash text-indigo-600">& Land Your Dream Job</span>
            </h2>
            <p className="text-base text-gray-700">We offer the most in-demand IT courses, taught by industry experts, to prepare you for success.</p>
            <div className="mt-10 flex flex-col items-center md:flex-row">
              <a href="/contact" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                Learn More</a>
              <a href="/contact" aria-label className="group inline-flex items-center font-semibold text-g1">Watch how
                it works
        ...
        <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
          ...
          <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
            <img src="https://img.freepik.com/premium-photo/businessman-having-presentation-with-colleagues-about-project-he-working-office_232070-13904.jpg?size=626&ext=jpg&ga=GA1.1.1433286368.1718702777&semt=sph" alt="about"/>
          </div>
        </div>
      </div>
    </div> 
    ...
    <div className=" absolute -bottom-24 left-10 z-0  opacity-10 "> 
      <svg width="800px" height="100px" viewBox="0 0 24 24" className="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300" fill="none" xmlns="http://www.w3.org/2000/svg">
