    ...
    <div>
      <section className="pt-16 pb-7 bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between pb-7 border-b border-gray-500 gap-8">
            <Link to="/" className>
              <img src="/cyberw.png" className="w-[200px]" alt="" />
              <p></p>
            </Link>
            <div className="flex items-center gap-4">
              <Link
                to="https://www.facebook.com/profile.php?id=61561569404957"
              ...
              <Link
                to="https://www.instagram.com/cybersolvings_edtech/"
          ...
          <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
            <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-12">
              <div className>
              ...
              <div className>
                <h6 className="text-lg font-medium text-white mb-7 max-lg:text-center pb-7"></h6>
                ...
                <ul className="flex flex-col gap-6 max-lg:items-center">
                  ...
                  <li>
                    <Link
                      ...
                      className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400"
                    >
                      Address: DD building, opp. New Bus Stand,
                ...
                <form action="#" className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                    <div className="flex items-start black">
                      ...
                      >
                        Subscribe to our{" "}
                        <Link to="javascript:;" className="text-amber-500">
                          Newsletter{" "}
                        </Link>{" "}
                        for the{" "}
                        <Link to="javascript:;" className="text-amber-500">
          ...
          <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
            <span className="text-sm font-normal text-gray-400">
              <Link to="https://pagedone.io/" className>
                © 2024
              </Link>{" "}
              Cybersolvings. All rights reserved.
            </span>
