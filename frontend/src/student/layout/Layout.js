...
const navigation = [
  ...
  //   icon: IoBookSharp,
  //   children: [
  //     { name: "Classes", href: "/section-info" },
  ...
  { name: 'Query', href: '/queries', icon: BiMessageAltError  , current: false },
  {
    name: "Attendance",
    href: "/attendance",
                      ...
                      {!item.children ? (
                        <Link
                          ...
                          className={classNames(
                            item.current ? "bg-gray-50 text-indigo-900" : "hover:bg-gray-50 hover:text-indigo-900",
                            "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700"
                          )}
                        >
                          <item.icon
                            aria-hidden="true"
                            className={`h-6 w-6 ${item.current ? "text-indigo-900" : "hover:text-indigo-900"}shrink-0 text-gray-400`}
                          />
                          {item.name}
                        </Link>
                      ) : (
                          ...
                          <DisclosureButton
                            ...
                            className={classNames(
                              item.name === activeTab
                                ...
                                : "hover:bg-gray-50 text-indigo-900",
