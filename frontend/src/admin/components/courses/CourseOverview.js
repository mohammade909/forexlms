...
import { deleteCourse,getcourseById } from "../../../redux/courseSlice";
// import { ActionConfirm } from "../../BaseFiles/ActionConfirm";
import { getReviews } from "../../../redux/reviewSlice";
import AddReview from "./AddReview";
import { Link } from "react-router-dom";
// import EnrollmentRequestDrawer from '../enrollment/EnrollmentRequestDrawer'
...
export default function CourseOverview() {
  ...
  const handleFormSubmit = (values) => {
    console.log('Enrollment Request Submitted:', values);
  };
  useEffect(() => {
      ...
      <div className="mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <p className="mt-6 text-gray-500" dangerouslySetInnerHTML={{ __html: course.course_description }}></p>
            ...
            <TabGroup>
              ...
              <TabPanels as={Fragment}>
                <TabPanel className="-mb-10">
                  ...
                  {auth && <AddReview reload={() => setReload(!reload)} />}
                </TabPanel>
